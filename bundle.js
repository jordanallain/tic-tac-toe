...
/***/ function(module, exports, __webpack_require__) {
	...
	var patchGame = function patchGame(i, v, g) {
	  // console.log(api.app.game);
	  api.update(i, v, g).done(ui.success).fail(ui.failure);
	};

	//function to check if three cells hold a value of X
	var allX = function allX(cellOne, cellTwo, cellThree) {
	  return cellOne === 'X' && cellTwo === 'X' && cellThree === 'X';
	};

	//function to check if three cells hold a value of O
	var allO = function allO(cellOne, cellTwo, cellThree) {
	...
	var xWinRows = function xWinRows() {
	  return allX(gameBoardArray[0], gameBoardArray[1], gameBoardArray[2]) || allX(gameBoardArray[3], gameBoardArray[4], gameBoardArray[5]) || allX(gameBoardArray[6], gameBoardArray[7], gameBoardArray[8]);
	};
	...
	var oWinRows = function oWinRows() {
	  return allO(gameBoardArray[0], gameBoardArray[1], gameBoardArray[2]) || allO(gameBoardArray[3], gameBoardArray[4], gameBoardArray[5]) || allO(gameBoardArray[6], gameBoardArray[7], gameBoardArray[8]);
	};
	...
	var xWinCol = function xWinCol() {
	  return allX(gameBoardArray[0], gameBoardArray[3], gameBoardArray[6]) || allX(gameBoardArray[1], gameBoardArray[4], gameBoardArray[7]) || allX(gameBoardArray[2], gameBoardArray[5], gameBoardArray[8]);
	};
	...
	var oWinCol = function oWinCol() {
	  return allO(gameBoardArray[0], gameBoardArray[3], gameBoardArray[6]) || allO(gameBoardArray[1], gameBoardArray[4], gameBoardArray[7]) || allO(gameBoardArray[2], gameBoardArray[5], gameBoardArray[8]);
	};
	...
	var xWinDiag = function xWinDiag() {
	  return allX(gameBoardArray[0], gameBoardArray[4], gameBoardArray[8]) || allX(gameBoardArray[6], gameBoardArray[4], gameBoardArray[2]);
	};
	...
	var oWinDiag = function oWinDiag() {
	  return allO(gameBoardArray[0], gameBoardArray[4], gameBoardArray[8]) || allO(gameBoardArray[6], gameBoardArray[4], gameBoardArray[2]);
	};
	...
	//and O
	var attachGameLogic = function attachGameLogic() {
	...
	module.exports = {
	  attachGameLogic: attachGameLogic
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = function update(i, v, g) {
	  return $.ajax({
